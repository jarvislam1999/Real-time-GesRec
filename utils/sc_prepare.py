...
dataset_path = '/mnt/data/yxchen/gesture-datasets/self-collect'
def extract_frames():
...
def convert_jester_csv_to_activitynet_json(label_csv_path, test_csv_path, dst_json_path):
...
csv_dir_path = './annotation_sc'
label_csv_path = os.path.join(csv_dir_path, 'classInd.txt')
test_csv_path = os.path.join(csv_dir_path, 'testlist01.txt')
dst_json_path = os.path.join(csv_dir_path, 'sc.json')

convert_jester_csv_to_activitynet_json(label_csv_path, test_csv_path, dst_json_path)
